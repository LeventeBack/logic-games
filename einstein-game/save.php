<?php 
  ...
  if(isset($_SESSION['games_player'])){
    ...
    if($history->num_rows == 0){
      $sql = "INSERT INTO einstein_game (player_id, institution, major, class, time, completed, score) 
              VALUES ('$player_id', '$institution', '$major', '$class', '$time', '$completed', '$score') ";
